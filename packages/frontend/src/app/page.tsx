...
import SolanaMetrics from '../components/ui/SolanaMetrics';
...
// Enhanced Dashboard Home Component with Real-time Data
  ...
  React.useEffect(() => {
    const interval = setInterval(() => {
      setRealTimeData(prev => ({
        ...
        totalChannels: prev.totalChannels + Math.floor(Math.random() * 3 - 1),
        messagesToday: prev.messagesToday + Math.floor(Math.random() * 100),
        networkTps: 2000 + Math.floor(Math.random() * 2000)
      }));
    }, 3000);
    ...
    <div className="max-w-7xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          { 
            label: 'Active Agents', 
            value: realTimeData.activeAgents.toLocaleString(), 
            change: '+12.5%', 
            color: 'purple',
            icon: CpuChipIcon
          },
          { 
            ...
            value: realTimeData.totalChannels.toLocaleString(), 
            change: '+8.2%', 
            color: 'cyan',
          ...
          { 
            ...
            value: `${(realTimeData.messagesToday / 1000).toFixed(1)}K`, 
            change: '+23.1%', 
            color: 'green',
            icon: ChartBarIcon
          },
          ...
          <motion.div
            ...
            className="bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-lg p-6 hover:border-purple-500/30 transition-all group"
          >
